...
<html>
    <head>
		...
		<script src="<%=request.getContextPath()%>js/ChunkFive_400.font.js" type="text/javascript"></script>
    ...
    <body>
		...
		<div class="footer">
			<a href="http://tympanus.net/codrops/2011/01/03/parallax-slider/"><< Back to the Codrops tutorial</a>
